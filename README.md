...
Simulador visual e interactivo de aerogeneradores flotantes en un tanque de agua con efecto estela (wake effect). Basado en el proyecto [Floating Farm](https://github.com/) que utiliza un Raspberry Pi Pico para controlar un aerogenerador flotante real.
